...
def sanitize_output(debug_output):
    ...
    # Additional sanitation can be added here if needed
...
def main():
    ...
    while validation_result.lower() != 'yes':
        user_prompt = read_file("F:\\AutoCoder\\AutoCoder\\prompt.txt")
        ...
        if validation_result and validation_result.lower() == 'no':
            ...
            if last_script_path:
                ...
                if latest_debug_output_file:
                    ...
                    with open("F:\\AutoCoder\\AutoCoder\\prompt.txt", "w") as file:
