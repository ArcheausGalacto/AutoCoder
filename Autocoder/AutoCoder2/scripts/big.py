...
def save_to_file(code, directory="F:\\AutoCoder\\AutoCoder2\\output_scripts", base_filename="output"):
...
def save_original_prompt(original_prompt, original_prompt_file="F:\\AutoCoder\\AutoCoder2\\original_prompt.txt"):
